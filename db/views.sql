...
-- Annual Championship (specific season) --

CREATE VIEW AnnualChampionship AS
SELECT M.match_id, M.match_date, M.home_score, M.away_score, TH.team_name AS home_team, TA.team_name AS away_team
FROM Matches M
JOIN Teams TH ON M.home_team_id = TH.team_id
JOIN Teams TA ON M.away_team_id = TA.team_id;

-- Test query for view MatchSchedule --
SELECT * FROM MatchSchedule WHERE match_date = '2023-05-01';

-- Test query for view AnnualChampionship --
SELECT * FROM AnnualChampionship WHERE match_date BETWEEN '2022-09-01' AND '2023-06-30';